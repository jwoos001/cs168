...
struct iptmpl {
    QIRD  * I661;
    struct vcs_globals_t * I662;
    void * I664;
    UP  I665;
    UP  I666;
    struct iptmpl * I657[2];
};
typedef unsigned long long FileOffset;
typedef struct _hsimPeriodL {
    char  I829[256];
    struct _hsimPeriodL * I792;
} HsimPeriodL;
typedef struct {
    U   I831[2];
    U  I832 :1;
...
struct dummyq_struct {
    ...
    struct futq * I982;
    struct futq * I983;
    struct sched_table * I984;
    struct millenium * I986;
    EBLK  * I988;
    EBLK  * I989;
    EBLK  * I990;
    EBLK  * I991;
